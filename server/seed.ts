...
import { PodcastModel, PodcastAttributes } from './db/models/podcast';

async function seed() {
  await db.sync({ force: true });
  console.log('db synced!');

  const podcasts: PodcastAttributes[] = [
    {
      name: 'Brain Sparks',
      description:
    ...
    },
    {
      ...
      image:
        'https://cdn-images-1.listennotes.com/podcasts/the-dirt-fresh-tilled-soil-NltidraUxJy.1400x1400.jpg',
  ...
  const newPodcast = await PodcastModel.bulkCreate(podcasts);
